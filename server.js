...
// ─────────────── 알림 유틸 ───────────────
let Notification; // 나중에 모델 정의 후 할당
...
// (예전 내장 orders 필드 - 현재는 별도 Order 컬렉션 사용)
orders: [
{
productId: { type: mongoose.Schema.Types.ObjectId, ref: 'Product' },
name: String,
...
// ======================================================================
// ─────────────── 쇼핑(Product / Review / Cart / Order) API ───────────────
// ======================================================================
...
res.json({ success: true, updatedOrder: updated });
} catch (err) {
res.status(500).json({ error: err.message });
}
});
